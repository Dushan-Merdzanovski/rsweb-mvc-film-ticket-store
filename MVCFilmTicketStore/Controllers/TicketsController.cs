...
namespace MVCFilmTicketStore.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(MVCFilmTicketStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCFilmTicketStoreContext = _context.Ticket.Include(t => t.Projection);
        ...
        public async Task<IActionResult> Create([Bind("Id,BoughtTime,DownloadTicketUrl,IsValid,AppUser,ProjectionId")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BoughtTime,DownloadTicketUrl,IsValid,AppUser,ProjectionId")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
